...
export const LoginForm = () => {
    ...
    return (
        <div className="w-full max-w-[500px] mx-auto bg-white dark:bg-slate-900 p-10 rounded-[40px] shadow-xl border border-slate-50 dark:border-slate-800 flex flex-col justify-center transition-all duration-500">
            ...
            {!requiresTwoFactor ? (
                <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-6">
                    ...
                    <Button type="submit" variant="secondary" className="w-full h-14 text-lg font-bold shadow-lg shadow-secondary/20 hover:scale-[1.02] active:scale-95 transition-all" isLoading={isLoading}>
