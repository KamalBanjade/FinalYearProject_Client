...
export function DirectorySkeleton() {
    return (
        <div className="max-w-7xl mx-auto px-6 md:px-8 pt-2 pb-12 space-y-6">
            {/* Toolbar Skeleton */}
            ...
            <div className="bg-white/50 dark:bg-slate-900/40 backdrop-blur-2xl rounded-[3rem] border border-slate-200/50 dark:border-slate-800/50 shadow-xl overflow-hidden p-8">
