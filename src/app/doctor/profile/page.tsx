            ...
            <div className={`group relative rounded-[4rem] p-12 overflow-hidden backdrop-blur-md shadow-premium border transition-all duration-700 ${isEditing ? 'bg-indigo-50/70 dark:bg-indigo-900/40 border-indigo-200 dark:border-indigo-500/30' : 'bg-white/70 dark:bg-slate-900/70 border-white/20 dark:border-white/5'}`}>
                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
                    <div className="flex flex-col lg:flex-row items-center gap-10 text-center lg:text-left">
                        <div className="relative">
                            <div className="w-40 h-40 bg-gradient-to-br from-primary via-primary to-secondary p-1 rounded-[3.5rem] shadow-elevated transition-transform duration-700 hover:scale-105">
                                <div className="w-full h-full bg-white dark:bg-slate-900 rounded-[3.25rem] flex items-center justify-center overflow-hidden">
                                    <span className="text-5xl font-black text-primary dark:text-white">
                                        {profile.firstName.charAt(0)}{profile.lastName.charAt(0)}
                                    </span>
                                </div>
                            </div>
                            <div className="absolute -bottom-3 -right-3 w-12 h-12 bg-secondary rounded-[1.25rem] border-[6px] border-white dark:border-slate-900 flex items-center justify-center shadow-xl">
